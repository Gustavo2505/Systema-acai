<template>
  <div id="app">
    <v-flex xs12 sm6 md3>
      <img src="https://www.oggisorvetes.com.br/images/acai.png" alt="avatar">

      <v-text-field color="white" placeholder="Usuário" autofocus="true"></v-text-field>
